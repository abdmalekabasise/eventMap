...
import img1 from './../../images/blog/grid/img1.jpg';
import img2 from './../../images/blog/grid/img2.jpg';
...
import thumb1 from './../../images/blog/default/thum1.jpg';
import listingPic1 from './../../images/listing/grid/pic1.jpg';
							...
							<div className="col-lg-8 col-xl-8 p-b30">
								...
								<div className="blog-post blog-single">
									...
									<div className="dlab-post-text">
										<p className="font-weight-400">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco  laboris nisi ut aliquip ex ea commodo amet set for your cool happiness for your loyal city.</p>
										...
										<blockquote>
											<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt with ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation a deef ullamco laboris nisi ut aliquip ex ea commodo consequat see you again tomorrow.</p>
											<h6>- Rosalina Pong</h6>
										</blockquote>
										...
										<div className="dlab-post-media m-b50">
											<Link to={'#'}><img src={thumb1} alt="" /></Link>
										</div>
										...
										<div className="clearfix m-b50">
											<img className="alignleft" src={listingPic1} alt="" />
											<p className="font-weight-300">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
										</div>
									</div>
								...
								<div className="author-info text-center m-b30">
									...
									<p className="font-14 m-b0">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
								</div>
